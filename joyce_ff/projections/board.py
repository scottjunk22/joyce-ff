...
def build_all(seasons=history.SEASONS_DEFAULT, draft_season=DRAFT_SEASON) -> dict:
    ...
    return {
        ...
        "league": {
            ...
            "rostered_rb": rules.ROSTERED_RB_LEAGUEWIDE,
            "rostered_r": rules.ROSTERED_R_LEAGUEWIDE,
            "started_rb": rules.STARTED_RB_LEAGUEWIDE,
            "started_r": rules.STARTED_R_LEAGUEWIDE,
        },
